...
create table branas_store.orders (
...
create table branas_store.items (
    id_order integer REFERENCES branas_store.orders(order_id),
    id_product integer REFERENCES branas_store.product(id_product),
    price numeric,
    quantity integer,
